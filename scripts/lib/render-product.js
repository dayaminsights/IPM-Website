...
function applyVariant(idx, crossfade) {
  ...
  if (currentPrice) { const pt = currentPrice.closest('.price-tag'); if (v.price) { currentPrice.textContent = v.price; if (pt) pt.style.display = ''; } else { if (pt) pt.style.display = 'none'; } }
